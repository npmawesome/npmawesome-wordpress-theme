...
$twitter   = npmawesome_tweet($desc, $permalink, 'via @npmawesome #javascript #nodejs');
...
$default_width = 'style="width: 14.2857142857143%;"';
?>

<div class="SocialButtons">
  <!-- Buttons start here. Copy this ul to your document. -->
  <ul class="rrssb-buttons clearfix">
    <li class="email" <?php echo $default_width ?>>
      <a href="mailto:?subject=<?php echo $title ?>&amp;body=<?php echo $permalink.urlencode('\n\n').$desc ?>">
        <span class="icon">
    ...
    <li class="twitter" <?php echo $default_width ?>>
      <a href="http://twitter.com/home?status=<?php echo $twitter ?>" class="popup">
        <span class="icon">
    ...
    <li class="facebook" <?php echo $default_width ?>>
    ...
    <li class="linkedin" <?php echo $default_width ?>>
      <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $permalink ?>&amp;title=<?php echo $title ?>&amp;summary=<?php echo $desc ?>" class="popup">
        <span class="icon">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
    ...
    <li class="reddit" <?php echo $default_width ?>>
      <a href="http://www.reddit.com/submit?url=<?php echo $permalink ?>">
        <span class="icon">
    ...
    <li class="googleplus" <?php echo $default_width ?>>
      <a href="https://plus.google.com/share?url=<?php echo $permalink ?>" class="popup">
        <span class="icon">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
            <g>
              <g>
    ...
    <?php if($is_module) { ?>
      <li class="github" <?php echo $default_width ?>>
        <a href="https://github.com/<?php echo get_field('module_github') ?>">
          <span class="icon">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
               width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
